...
class ControlLayout {
	public:
		...
		void draw_control_heading(Block block, char str1[], char str2[],char str3[])
		{
			glColor3f(0, 0, 0);
		...
		void draw_layout_keyboard()
		{
			...
			draw_control_heading(Block(400, 850, 1520,950),"ACTION", "PRIMARY", "ALTERNATE");
		...
		void draw_layout_controller()
		{
			...
			draw_control_heading(Block(400, 850, 1520, 950), "ACTION", "PRIMARY", "");
